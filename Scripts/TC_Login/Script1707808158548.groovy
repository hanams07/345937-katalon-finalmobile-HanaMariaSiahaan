...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.TextView - USER NAME'), username, 0)

Mobile.setText(findTestObject('Object Repository/Login/android.widget.TextView - PASSWORD'), password, 0)
